...
$sqlinsert = "INSERT INTO `tbl_items`(`user_id`,`item_brand`,`item_name`, `item_desc`, `item_type`, `item_interest`, `item_lat`, `item_long`, `item_state`, `item_locality`) VALUES ('$userid','$item_brand','$item_name','$item_desc','$item_type','$item_interest','$latitude','$longitude','$state','$locality')";
