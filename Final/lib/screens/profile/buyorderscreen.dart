...
class BuyOrderScreen extends StatefulWidget {
  final User user;
  const BuyOrderScreen({super.key, required this.user});
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return ListTile(
                              ...
                              title:
                                  Text("OrderID: ${orderList[index].orderId}"),
                              ...
                              subtitle: Row(
                                ...
                                children: [
                                  Column(
                                      ...
                                      children: [
                                        Text(
                                            "Order: ${orderList[index].itemBrand} ${orderList[index].itemName}"),
                                        Text(
    ...
    http.post(
      ...
      if (response.statusCode == 200) {
        ...
        if (jsondata['status'] == "success") {
          ...
          showCustomSnackBar("No order found");
        }
        setState(() {});
      }
    });
