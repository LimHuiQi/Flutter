...
class SellOrderScreen extends StatefulWidget {
  final User user;
  const SellOrderScreen({super.key, required this.user});
...
class _SellOrderScreenState extends State<SellOrderScreen> {
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return ListTile(
                              ...
                              title:
                                  Text("SalesID: ${orderList[index].orderId}"),
                              ...
                              subtitle: Row(
                                ...
                                children: [
                                  Column(
                                      ...
                                      children: [
                                        Text(
                                            "Sales: ${orderList[index].itemBrand} ${orderList[index].itemName}"),
                                        Text(
                                  ...
                                  Column(
                                    children: [
                                      Text(
                                        "RM ${double.parse(orderList[index].itemPrice.toString()).toStringAsFixed(2)}",
                                        style: const TextStyle(
                                            fontSize: 16,
                                            fontWeight: FontWeight.bold),
                                      ),
  ...
  void loadsellerorders() {
    ...
    http.post(
        Uri.parse("${MyConfig().server}/barterit/php/load_sellerorder.php"),
      ...
      if (response.statusCode == 200) {
        ...
        if (jsondata['status'] == "success") {
          ...
          showCustomSnackBar("No sales found");
        }
        setState(() {});
      }
    });
