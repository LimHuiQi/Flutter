...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void onGuestLogin() {
    ...
    String guestEmail = "na";
    String guestPassword = "na";

    // Display a snackbar or any loading indicator to indicate the guest login process
    showCustomSnackBar("Logging in as a guest...");

    // Simulate a network request or perform any necessary actions
    Future.delayed(const Duration(seconds: 2), () {
      ...
      showCustomSnackBar("Guest login successful");

      // Navigate to the MainScreen with the guestUser object
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
